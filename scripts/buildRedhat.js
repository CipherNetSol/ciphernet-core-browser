...
require('./createPackage.js')('linux', { arch: Arch.x64 }).then(function (path) {
  var installerOptions = {
    artifactName: 'ciphernet-${version}-${arch}.rpm',
    packageName: 'CipherNet',
    icon: 'icons/icon256.png',
    category: 'Network',
    packageCategory: 'Network',
    mimeTypes: ['x-scheme-handler/http', 'x-scheme-handler/https', 'text/html'],
    maintainer: 'CipherNet Developers <280953907a@zoho.com>',
    synopsis: 'CipherNet is a fast, minimal browser that protects your privacy.',
